...
const codeHistory_1 = __webpack_require__(43);
function activate(context) {
    ...
    const fixCommand = vscode.commands.registerCommand('extension.refactorCode', async () => {
        ...
        try {
            // Call NestJS API
            const response = await axios_1.default.post('https://code-refactor-backend-production.up.railway.app/ai/refactor/open-route', {
                code: selectedText,
                language,
            });
